...
public class JumpReset extends Module {
    ...
    private ButtonSetting lockKillAuraTarget;
    ...
    public JumpReset() {
        ...
        this.registerSetting(lockKillAuraTarget = new ButtonSetting("Lock aim to KA target", false));
    ...
    public void onPreUpdate(PreUpdateEvent e) {
        ...
        if (hurtTime > lastHurtTime) {
            ...
            if (!ignoreNext && !mc.thePlayer.isBurning() && onGround && aimingAt && forward && mouseDown && randomization && !hasBadEffect() && fov) {
                ...
                if (lockKillAuraTarget.isToggled() && ModuleManager.killAura != null && KillAura.target != null) {
                    float[] rot = RotationUtils.getRotations(KillAura.target, mc.thePlayer.rotationYaw, mc.thePlayer.rotationPitch);
                    if (rot != null) {
